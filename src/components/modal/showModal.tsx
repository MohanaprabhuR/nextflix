            ...
            >
              <Dialog.Panel className="w-full  transform overflow-hidden rounded-[16px_16px_0px_0px] bg-white  shadow-xl transition-all pb-40 max-sm:pb-20 ">
                ...
                <div className="relative">
                  ...
                  <div className="px-[48px] py-6 bg-[linear-gradient(180deg,rgba(0,0,0,0.00)_1.89%,rgba(0,0,0,0.03)_121.51%)]   absolute bottom-0 left-0 w-full max-md:relative max-lg:p-5">
